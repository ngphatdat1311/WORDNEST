...
| Hệ điều hành | Tải về |
|---|---|
| Windows | [WordNest.Setup.1.0.1.exe](https://github.com/ngphatdat1311/WORDNEST/releases/download/v1.0.1/WordNest.Setup.1.0.1.exe) |
| macOS (Intel & Apple Silicon) | [WordNest-1.0.1-universal.dmg](https://github.com/ngphatdat1311/WORDNEST/releases/download/v1.0.1/WordNest-1.0.1-universal.dmg) |
